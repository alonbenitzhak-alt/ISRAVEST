    ...
    <>
      ...
      <section className="relative h-72 md:h-80 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
          ...
          <p className="text-white/80 text-lg">
            {countryProperties.length} investment{" "}
            {countryProperties.length === 1 ? "property" : "properties"} available
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-6">
          Properties in {country.name}
        </h2>

        {countryProperties.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-2xl border border-gray-200">
            <p className="text-gray-500 text-lg">
              No properties available in {country.name} at the moment.
            </p>
