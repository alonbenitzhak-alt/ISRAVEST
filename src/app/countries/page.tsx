    ...
    <>
      <section className="bg-gradient-to-r from-primary-800 to-primary-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Investment Countries</h1>
          <p className="text-primary-100 text-lg">
            Explore real estate opportunities across our curated markets
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {countries.map((country) => {
            const countryProperties = properties.filter(
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-5">
                    ...
                    <p className="text-white/80 text-sm">
                      {countryProperties.length} available{" "}
                      {countryProperties.length === 1 ? "property" : "properties"}
                    </p>
                  </div>
                </div>
                <div className="p-5">
